...
return {
  ...
  hlsl = { "slangd" },
  hoon = { "hoon_ls" },
  html = { "angularls", "antlersls", "ast_grep", "biome", "codebook", "djlsp", "emmet_language_server", "emmet_ls", "harper_ls", "herb_ls", "html", "htmx", "ltex", "ltex_plus", "lwc_ls", "stimulus_ls", "stylelint_lsp", "superhtml", "tailwindcss", "unocss" },
  ...
  javascript = { "ast_grep", "biome", "codebook", "cssmodules_ls", "denols", "dprint", "ember", "eslint", "glint", "harper_ls", "htmx", "lwc_ls", "oxlint", "quick_lint_js", "rome", "snyk_ls", "tailwindcss", "ts_ls", "tsgo", "unocss", "vtsls" },
  ["javascript.glimmer"] = { "ember", "glint" },
  ["javascript.jsx"] = { "ast_grep", "denols", "eslint", "oxlint", "ts_ls", "tsgo", "vtsls" },
  ...
  terraform = { "snyk_ls", "terraformls", "tflint", "tofu_ls" },
  ...
  typescript = { "angularls", "ast_grep", "biome", "codebook", "cssmodules_ls", "denols", "dprint", "ember", "eslint", "glint", "harper_ls", "htmx", "oxlint", "quick_lint_js", "rome", "snyk_ls", "tailwindcss", "ts_ls", "tsgo", "unocss", "vtsls" },
  ["typescript.glimmer"] = { "ember", "glint" },
  ["typescript.tsx"] = { "angularls", "ast_grep", "biome", "denols", "eslint", "oxlint", "rome", "ts_ls", "tsgo", "vtsls" },
