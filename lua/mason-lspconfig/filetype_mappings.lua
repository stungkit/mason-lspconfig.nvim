...
return {
  ...
  crystal = { "crystalline" },
  cs = { "ast_grep", "csharp_ls", "harper_ls", "omnisharp" },
  ...
  ["javascript.jsx"] = { "denols", "eslint", "oxlint", "ts_ls", "tsgo", "vtsls" },
  ...
  ["typescript.tsx"] = { "angularls", "biome", "denols", "eslint", "oxlint", "rome", "ts_ls", "tsgo", "vtsls" },
  ...
  xsl = { "lemminx" },
  xslt = { "lemminx" },
  yaml = { "ast_grep", "azure_pipelines_ls", "gh_actions_ls", "home_assistant", "hydra_lsp", "snyk_ls", "spectral", "yamlls" },
